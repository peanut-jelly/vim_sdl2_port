...
// used for elegant quittting, instead of exit(0) quitting whole process.
int myVimRunning=1;
/*
...
# endif
    ...
    //info_push_messagef("in getout t%d", SDL_GetTicks());
    mch_exit(exitval);
}
