 ...
 */
    void
trans_characters(char_u* buf, int bufsize)
    //char_u	*buf;
    //int		bufsize;
{
 ...
 */
    char_u *
str_foldcase(char_u* str, int orglen, char_u* buf, int buflen)
    //char_u	*str;
    //int		orglen;
    //char_u	*buf;
    //int		buflen;
 ...
 */
    int
win_linetabsize(win_T* wp, char_u* p, colnr_T len)
    //win_T	*wp;
    //char_u	*p;
    //colnr_T	len;
{
 ...
 */
    int
lbr_chartabsize(char_u* s, colnr_T col)
    //unsigned char	*s;
    //colnr_T		col;
{
#ifdef FEAT_LINEBREAK
 ...
 */
    int
lbr_chartabsize_adv(char_u** s, colnr_T col)
    //char_u	**s;
    //colnr_T	col;
{
    int		retval;
 ...
 */
    int
win_lbr_chartabsize(win_T* wp, char_u* s, colnr_T col, int* headp)
    //win_T	*wp;
    //char_u	*s;
    //colnr_T	col;
    //int		*headp UNUSED;
 ...
 */
    static int
win_nolbr_chartabsize(win_T* wp, char_u* s, colnr_T col, int* headp)
    //win_T	*wp;
    //char_u	*s;
    //colnr_T	col;
    //int		*headp;
