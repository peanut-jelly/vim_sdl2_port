 ...
 */
    void
change_indent(int type, int amount, int round, int replaced, 
...
# endif
	...
	if (emsg_silent == 0)
	{
	    ...
	    setcursor();
	    out_flush();
	    fnWarn("option `dict' and `tsr' are empty");
            //ui__delay(2000L, FALSE);
	}
	return FALSE;
    }
    return TRUE;
 ...
 */
    int
ins_compl_add_infercase(char_u * str, int len, int icase, 
        char_u *fname, int dir, int flags)
    //char_u	*str;
    //int		len;
    //int		icase;
    //char_u	*fname;
 ...
 */
    static int
ins_compl_add(char_u *str, int len, int icase, 
        char_u *fname, char_u **cptext, int cdir, int flags, int adup)
    //char_u	*str;
    //int		len;
    //int		icase;
    //char_u	*fname;
 ...
 */
    static void
ins_compl_add_matches(int num_matches, char_u **matches, int icase)
    //int		num_matches;
    //char_u	**matches;
    //int		icase;
{
 ...
 */
    static void
ins_compl_dictionaries(char_u *dict_start, char_u *pat, 
        int flags, int thesaurus)
    //char_u	*dict_start;
    //char_u	*pat;
...
theend:
    ...
    static void
ins_compl_files(int count, char_u **files, int thesaurus, int flags, 
 ...
 */
    static int
ins_compl_next(int allow_get_expansion, int count, int insert_match)
 ...
 */
    static void
internal_format(int textwidth, int second_indent, int flags, int format_only, 
        int c)
    //int		textwidth;
    //int		second_indent;
    //int		flags;
 ...
 */
    static void
start_arrow(pos_T *end_insert_pos)
 ...
 */
    static void
stop_insert(pos_T *end_insert_pos, int esc)
 ...
 */
    int
in_cinkeys(int keytyped, int when, int line_is_empty)
    //int		keytyped;
    //int		when;
    //int		line_is_empty;
{
