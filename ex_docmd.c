 ...
 */
    int
do_cmdline(char_u* cmdline, char_u* (*fgetline)__ARGS((int, void*, int)), 
 ...
 */
    int
getline_equal(char_u* (*fgetline)__ARGS((int, void*, int)), 
        void* cookie, 
 ...
 */
    void *
getline_cookie(char_u* (*fgetline)__ARGS((int, void*, int)), 
        void* cookie)
...
#endif
				    char_u* (*fgetline)__ARGS((int, void*, int)), void* cookie)
    //char_u		**cmdlinep;
    //int			sourcing;
#ifdef FEAT_EVAL
    //struct condstack	*cstack;
 ...
 */
    char_u *
set_one_cmd_context(expand_T* xp, char_u* buff)
    //expand_T	*xp;
 ...
 */
    static linenr_T
get_address(char_u** ptr, int skip, int to_other_file)
    //char_u	**ptr;
 ...
 */
    static char_u *
repl_cmdline(exarg_T* eap, char_u* src, int srclen, char_u* repl, 
        char_u** cmdlinep)
    //exarg_T	*eap;
    //char_u	*src;
    //int		srclen;
 ...
 */
    char_u *
get_command_name(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
    if (idx >= (int)CMD_SIZE)
 ...
 */
    char_u *
get_user_commands(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
 ...
 */
    char_u *
get_user_cmd_flags(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
 ...
 */
    char_u *
get_user_cmd_nargs(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
 ...
 */
    char_u *
get_user_cmd_complete(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
 ...
 */
    int
parse_compl_arg(char_u* value, int vallen, int* complp, long* argt, 
        char_u** compl_arg)
    //char_u	*value;
    //int		vallen;
    //int		*complp;
 ...
 */
    static void
ex_win_close(int forceit, win_T* win, tabpage_T* tp)
    //int		forceit;
    //win_T	*win;
 ...
 */
    void
handle_drop(int filec, char_u** filev, int split)
 ...
 */
    FILE *
open_exfile(char_u* fname, int forceit, char* mode)
    //char_u	*fname;
    //int		forceit;
 ...
 */
    static int
makeopens(FILE* fd, char_u* dirnow)
    //FILE	*fd;
    //char_u	*dirnow;	/* Current directory name */
{
    ...
    static int
ses_winsizes(FILE* fd, int restore_size, win_T* tab_firstwin)
    //FILE	*fd;
    //int		restore_size;
    //win_T	*tab_firstwin;
{
 ...
 */
    static int
ses_fname(FILE* fd, buf_T* buf, unsigned int* flagp)
    //FILE	*fd;
    //buf_T	*buf;
    //unsigned	*flagp;
{
 ...
 */
    static int
ses_put_fname(FILE* fd, char_u* name, unsigned int* flagp)
    //FILE	*fd;
    //char_u	*name;
    //unsigned	*flagp;
{
 ...
 */
    char_u *
get_behave_arg(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
    if (idx == 0)
