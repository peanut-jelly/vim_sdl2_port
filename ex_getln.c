 ...
 */
    char_u *
getcmdline(int firstc, long count, int indent)
    //int		firstc;
 ...
 */
    char_u *
getexline(int c, void* cookie, int indent)
 ...
 */
    char_u *
getexmodeline(int promptc, void* cookie, int indent)
 ...
 */
    static int
nextwild(expand_T* xp, int type, int options, int escape)
    //expand_T	*xp;
    //int		type;
 ...
 */
    static int
showmatches(expand_T* xp, int wildmenu)
    //expand_T	*xp;
    //int		wildmenu UNUSED;
{
 ...
 */
    char_u *
addstar(char_u*fname, int len, int context)
    //char_u	*fname;
    //int		len;
    ...
    //expand_T	*xp;
{
    ...
    void
set_cmd_context(expand_T* xp, char_u* str, int len, int col)
    //expand_T	*xp;
 ...
 */
    static int
ExpandUserList(expand_T* xp, int* num_file, char_u*** file)
    //expand_T	*xp;
    //int		*num_file;
    //char_u	***file;
{
 ...
 */
    static int
ExpandRTDir(char_u* pat, int* num_file, char_u*** file, char*dirnames[])
    //char_u	*pat;
    //int		*num_file;
    //char_u	***file;
    //char	*dirnames[];
 ...
 */
    char_u *
globpath(char_u* path, char_u* file, int expand_options)
    //char_u	*path;
    //char_u	*file;
    //int		expand_options;
{
 ...
 */
    static char_u *
get_history_arg(expand_T* xp, int idx)
    //expand_T	*xp UNUSED;
    //int		idx;
{
 ...
 */
    void
add_to_history(int histype, char_u* new_entry, int in_map, int sep)
    //int		histype;
    //char_u	*new_entry;
 ...
 */
    static int
hist_type2char(int type, int use_question)
    //int	    type;
