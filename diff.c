 ...
 */
    void
diff_mark_adjust(linenr_T line1, linenr_T line2, 
 ...
 */
    static void
diff_mark_adjust_tp(tabpage_T *tp, int idx, linenr_T line1, linenr_T line2, 
        long amount, long amount_after)
    //tabpage_T	*tp;
    //int		idx;
    //linenr_T	line1;
 ...
 */
    static void
diff_file(char_u *tmp_orig, char_u *tmp_new, char_u *tmp_diff)
    //char_u	*tmp_orig;
    //char_u	*tmp_new;
    //char_u	*tmp_diff;
{
 ...
 */
    void
diff_win_options(win_T *wp, int addbuf)
    //win_T	*wp;
 ...
 */
    static void
diff_read(int idx_orig, int idx_new, char_u *fname)
 ...
 */
    static void
diff_copy_entry(diff_T *dprev, diff_T *dp, int idx_orig, int idx_new)
    //diff_T	*dprev;
    //diff_T	*dp;
    //int		idx_orig;
    //int		idx_new;
