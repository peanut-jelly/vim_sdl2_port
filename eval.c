...
# if defined(FEAT_MBYTE) || defined(PROTO)
    int
eval_charconvert(char_u* enc_from, char_u* enc_to, 
        char_u* fname_from, char_u* fname_to)
    //char_u	*enc_from;
    //char_u	*enc_to;
    //char_u	*fname_from;
    //char_u	*fname_to;
...
# if defined(FEAT_DIFF) || defined(PROTO)
    void
eval_diff(char_u *origfile, char_u *newfile, char_u* outfile)
    //char_u	*origfile;
    //char_u	*newfile;
    //char_u	*outfile;
{
    ...
    void
eval_patch(char_u* origfile, char_u* difffile, char_u* outfile)
    //char_u	*origfile;
    //char_u	*difffile;
    //char_u	*outfile;
{
 ...
 */
    int
eval_to_bool(char_u *arg, int *error, char_u** nextcmd, int skip)
    //char_u	*arg;
    //int		*error;
    //char_u	**nextcmd;
 ...
 */
    char_u *
eval_to_string_skip(char_u* arg, char_u** nextcmd, int skip)
    //char_u	*arg;
    //char_u	**nextcmd;
    //int		skip;	    /* only parse, don't execute */
{
 ...
 */
    char_u *
eval_to_string(char_u* arg, char_u** nextcmd, int convert)
    //char_u	*arg;
    //char_u	**nextcmd;
    //int		convert;
{
 ...
 */
    char_u *
eval_to_string_safe(char_u* arg, char_u** nextcmd, int use_sandbox)
    //char_u	*arg;
    //char_u	**nextcmd;
    //int		use_sandbox;
{
 ...
 */
    int
call_vim_function(char_u* func, int argc, char_u** argv, int safe, 
        int str_arg_only, typval_T* rettv)
    //char_u      *func;
    //int		argc;
    //char_u      **argv;
 ...
 */
    long
call_func_retnr(char_u* func, int argc, char_u** argv, int safe)
    //char_u      *func;
    //int		argc;
    //char_u      **argv;
    //int		safe;		/* use the sandbox */
 ...
 */
    void *
call_func_retstr(char_u* func, int argc, char_u** argv, int safe)
    //char_u      *func;
    //int		argc;
    //char_u      **argv;
    //int		safe;		/* use the sandbox */
 ...
 */
    void *
call_func_retlist(char_u* func, int argc, char_u** argv, int safe)
    //char_u      *func;
    //int		argc;
    //char_u      **argv;
    //int		safe;		/* use the sandbox */
 ...
 */
    static int
ex_let_vars(char_u* arg_start, typval_T* tv, int copy, 
        int semicolon, int var_count, char_u* nextchars)
    //char_u	*arg_start;
    //typval_T	*tv;
 ...
 */
    static char_u *
skip_var_list(char_u* arg, int * var_count, int* semicolon)
    //char_u	*arg;
    //int		*var_count;
    //int		*semicolon;
{
 ...
 */
    static void
list_hashtable_vars(hashtab_T* ht, char_u* prefix, int empty, int* first)
    //hashtab_T	*ht;
    //char_u	*prefix;
    //int		empty;
    //int		*first;
 ...
 */
    static char_u *
ex_let_one(char_u* arg, typval_T* tv, int copy, 
 ...
 */
    static char_u *
get_lval(char_u* name, typval_T* rettv, lval_T* lp, int unlet, 
        int skip, int quiet, int fne_flags)
    //char_u	*name;
    //typval_T	*rettv;
    //lval_T	*lp;
    //int		unlet;
 ...
 */
    static void
set_var_lval(lval_T* lp, char_u* endp, typval_T* rettv, int copy, char_u* op)
    //lval_T	*lp;
    //char_u	*endp;
    //typval_T	*rettv;
    //int		copy;
 ...
 */
    void *
eval_for_line(char_u* arg, int* errp, char_u** nextcmdp, int skip)
    //char_u	*arg;
    //int		*errp;
    //char_u	**nextcmdp;
    //int		skip;
    ...
    //void *fi_void;
{
    ...
    void
set_context_for_expression(expand_T* xp, char_u* arg, cmdidx_T cmdidx)
    //expand_T	*xp;
    //char_u	*arg;
    //cmdidx_T	cmdidx;
{
 ...
 */
    static void
ex_unletlock(exarg_T* eap, char_u* argstart, int deep)
    //exarg_T	*eap;
    //char_u	*argstart;
    //int		deep;
{
    ...
    static int
do_unlet_var(lval_T* lp, char_u* name_end, int forceit)
    //lval_T	*lp;
    //char_u	*name_end;
    //int		forceit;
{
 ...
 */
    static int
do_lock_var(lval_T* lp, char_u* name_end, int deep, int lock)
    //lval_T	*lp;
    //char_u	*name_end;
    //int		deep;
    //int		lock;
 ...
 */
    static int
eval0(char_u* arg, typval_T* rettv, char_u** nextcmd, int evaluate)
    //char_u	*arg;
    //typval_T	*rettv;
    //char_u	**nextcmd;
    //int		evaluate;
 ...
 */
    static int
eval6(char_u** arg, typval_T* rettv, int evaluate, int want_string)
    //char_u	**arg;
    //typval_T	*rettv;
    //int		evaluate;
 ...
 */
    static int
eval7(char_u** arg, typval_T* rettv, int evaluate, int want_string)
    //char_u	**arg;
    //typval_T	*rettv;
    //int		evaluate;
 ...
 */
    static int
eval_index(char_u** arg, typval_T* rettv, int evaluate, int verbose)
    //char_u	**arg;
    //typval_T	*rettv;
    //int		evaluate;
 ...
 */
    static int
get_option_tv(char_u** arg, typval_T* rettv, int evaluate)
    //char_u	**arg;
 ...
 */
    void
list_free(list_T* l, int recurse)
    //list_T  *l;
 ...
 */
    static int
list_equal(list_T* l1, list_T* l2, int ic, int recursive)
    //list_T	*l1;
    //list_T	*l2;
 ...
 */
    static int
dict_equal(dict_T* d1, dict_T* d2, int ic, int recursive)
    //dict_T	*d1;
    //dict_T	*d2;
    //int		ic;	/* ignore case for strings */
    //int		recursive; /* TRUE when used recursively */
 ...
 */
    static int
tv_equal(typval_T* tv1, typval_T* tv2, int ic, int recursive)
    //typval_T *tv1;
    //typval_T *tv2;
    //int	     ic;	    /* ignore case */
    //int	     recursive;	    /* TRUE when used recursively */
 ...
 */
    static long
list_find_nr(list_T* l, long idx, int* errorp)
    //list_T	*l;
    //long	idx;
 ...
 */
    void
list_remove(list_T* l, listitem_T* item, listitem_T* item2)
    //list_T	*l;
    //listitem_T	*item;
    //listitem_T	*item2;
{
...
typedef struct join_S {
    ...
    static int
list_join_inner(garray_T* gap, list_T* l, char_u* sep, 
        int echo_style, int copyID, garray_T* join_gap)
 ...
 */
    static int
list_join(garray_T* gap, list_T* l, char_u* sep, int echo_style, int copyID)
    //garray_T	*gap;
    //list_T	*l;
    //char_u	*sep;
    //int		echo_style;
 ...
 */
    void
set_ref_in_ht(hashtab_T* ht, int copyID)
    //hashtab_T	*ht;
    //int		copyID;
{
    int		todo;
 ...
 */
    void
set_ref_in_item(typval_T* tv, int copyID)
    //typval_T	*tv;
    //int		copyID;
{
    dict_T	*dd;
 ...
 */
    void
dict_free(dict_T* d, int recurse)
    //dict_T  *d;
    //int	    recurse;	/* Free Lists and Dictionaries recursively. */
{
    int		todo;
 ...
 */
    int
dict_add_nr_str(dict_T* d, char* key, long nr, char_u* str)
    //dict_T	*d;
    //char	*key;
    //long	nr;
    //char_u	*str;
 ...
 */
    static char_u *
echo_string(typval_T* tv, char_u** tofree, char_u* numbuf, int copyID)
    //typval_T	*tv;
    //char_u	**tofree;
    //char_u	*numbuf;
    //int		copyID;
 ...
 */
    static char_u *
tv2string(typval_T* tv, char_u** tofree, char_u* numbuf, int copyID)
    //typval_T	*tv;
    //char_u	**tofree;
    //char_u	*numbuf;
    //int		copyID;
 ...
 */
    static int
string2float(char_u* text, float_T* value)
    //char_u	*text;
 ...
 */
    static char_u *
deref_func_name(char_u* name, int* lenp)
    //char_u	*name;
    //int		*lenp;
{
    dictitem_T	*v;
 ...
 */
    static int
get_func_tv(char_u* name, int len, typval_T* rettv, 
        char_u** arg, linenr_T firstline, linenr_T lastline, 
        int* doesrange, int evaluate, dict_T* selfdict)
    //char_u	*name;		/* name of the function */
 ...
 */
    static int
call_func(char_u* funcname, int len, typval_T* rettv, int argcount, 
        typval_T* argvars, linenr_T firstline, linenr_T lastline,
        int* doesrange, int evaluate, dict_T* selfdict)
 ...
 */
    static void
f_argidx(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_browse(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_BROWSE
 ...
 */
    static void
f_browsedir(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_BROWSE
    ...
    //typval_T	*rettv;
{
    ...
    int
func_call(char_u* name, typval_T* args, dict_T* selfdict, typval_T* rettv)
    //char_u	*name;
    //typval_T	*args;
    //dict_T	*selfdict;
    //typval_T	*rettv;
 ...
 */
    static void
f_changenr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_cindent(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_CINDENT
 ...
 */
    static void
f_clearmatches(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
 ...
 */
    static void
f_complete(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars;
    //typval_T	*rettv UNUSED;
{
    int	    startcol;
 ...
 */
    static void
f_complete_check(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_confirm(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
 ...
 */
    static void
f_cscope_connection(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_CSCOPE
 ...
 */
    static void
f_did_filetype(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_AUTOCMD
 ...
 */
    static void
f_diff_filler(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_DIFF
 ...
 */
    static void
f_diff_hlID(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_DIFF
 ...
 */
    static void
f_eventhandler(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_feedkeys(typval_T* argvars, typval_T* rettv)
    //typval_T    *argvars;
    //typval_T    *rettv UNUSED;
{
    int		remap = TRUE;
...
static void findfilendir __ARGS((typval_T *argvars, typval_T *rettv, int find_what));
    ...
    static void
findfilendir(typval_T* argvars, typval_T* rettv, int find_what)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
 ...
 */
    static void
foldclosed_both(typval_T* argvars, typval_T* rettv, int end)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
    //int		end UNUSED;
{
 ...
 */
    static void
f_foldlevel(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_FOLDING
 ...
 */
    static void
f_foldtext(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_FOLDING
 ...
 */
    static void
f_foldtextresult(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_FOLDING
 ...
 */
    static void
f_foreground(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_GUI
 ...
 */
    static void
f_garbagecollect(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars;
    //typval_T	*rettv UNUSED;
{
 ...
 */
    static void
get_buffer_lines(buf_T* buf, linenr_T start, linenr_T end, 
        int retlist, typval_T* rettv)
    //buf_T	*buf;
    //linenr_T	start;
    //linenr_T	end;
    //int		retlist;
 ...
 */
    static void
f_getcharmod(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_getcmdline(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->v_type = VAR_STRING;
 ...
 */
    static void
f_getcmdpos(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_getcmdtype(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->v_type = VAR_STRING;
 ...
 */
    static void
f_getfontname(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->v_type = VAR_STRING;
 ...
 */
    static void
f_getmatches(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_SEARCH_EXTRA
 ...
 */
    static void
f_getpid(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_getqflist(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_QUICKFIX
 ...
 */
    static void
f_getwinposx(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->vval.v_number = -1;
 ...
 */
    static void
f_getwinposy(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->vval.v_number = -1;
 ...
 */
    static win_T *
find_win_by_nr(typval_T* vp, tabpage_T* tp)
    //typval_T	*vp;
 ...
 */
    static void
getwinvar(typval_T* argvars, typval_T* rettv, int off)
    //typval_T	*argvars;
    //typval_T	*rettv;
 ...
 */
    static void
f_histadd(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_CMDHIST
 ...
 */
    static void
f_histdel(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_CMDHIST
 ...
 */
    static void
f_histget(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_CMDHIST
 ...
 */
    static void
f_histnr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		i;
 ...
 */
    static void
f_hostname(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u hostname[256];
 ...
 */
    static void
f_iconv(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_MBYTE
 ...
 */
    static void
get_user_input(typval_T* argvars, typval_T* rettv, int inputdialog)
    //typval_T	*argvars;
    //typval_T	*rettv;
    //int		inputdialog;
{
 ...
 */
    static void
f_inputrestore(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_inputsave(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_last_buffer_nr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		n = 0;
 ...
 */
    static void
f_line2byte(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifndef FEAT_BYTEOFF
 ...
 */
    static void
f_lispindent(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_LISP
 ...
 */
    static void
f_localtime(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_matchadd(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_SEARCH_EXTRA
 ...
 */
    static void
f_matcharg(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    if (rettv_list_alloc(rettv) == OK)
 ...
 */
    static void
f_matchdelete(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_SEARCH_EXTRA
 ...
 */
    static void
f_pumvisible(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_INS_EXPAND
 ...
 */
    static void
f_reltime(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_RELTIME
 ...
 */
    static void
f_reltimestr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_RELTIME
 ...
 */
    static void
f_remote_expr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->v_type = VAR_STRING;
 ...
 */
    static void
f_remote_foreground(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_CLIENTSERVER
...
# endif
    ...
    static void
f_remote_peek(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_CLIENTSERVER
...
# endif
    ...
    static void
f_remote_read(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u	*r = NULL;
 ...
 */
    static void
f_remote_send(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    rettv->v_type = VAR_STRING;
 ...
 */
    static void
f_screencol(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_screenrow(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    ...
    //typval_T	*rettv;
{
    ...
    static void
f_server2client(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_CLIENTSERVER
...
# endif
    ...
    static void
f_serverlist(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u	*r = NULL;
 ...
 */
    static void
f_setbufvar(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars;
    //typval_T	*rettv UNUSED;
{
    buf_T	*buf;
 ...
 */
    static void
f_setmatches(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_SEARCH_EXTRA
 ...
 */
    ...
    static void
setwinvar(typval_T* argvars, typval_T* rettv, int off)
    //typval_T	*argvars;
    //typval_T	*rettv UNUSED;
    //int		off;
{
 ...
 */
    static void
f_shiftwidth(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_spellbadword(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u	*word = (char_u *)"";
 ...
 */
    static void
f_spellsuggest(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_SPELL
 ...
 */
    static void
f_synID(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		id = 0;
 ...
 */
    static void
f_synIDattr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u	*p = NULL;
 ...
 */
    static void
f_synIDtrans(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		id;
 ...
 */
    static void
f_synconcealed(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
 ...
 */
    static void
f_synstack(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_SYN_HL
 ...
 */
    static void
f_tabpagebuflist(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_WINDOWS
 ...
 */
    static void
f_tabpagenr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		nr = 1;
 ...
 */
    static void
f_tabpagewinnr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		nr = 1;
 ...
 */
    static void
f_tagfiles(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    char_u	*fname;
 ...
 */
    static void
f_tempname(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    static int	x = 'A';
 ...
 */
    static void
f_wildmenumode(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv UNUSED;
{
#ifdef FEAT_WILDMENU
 ...
 */
    static void
f_wincol(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    validate_cursor();
 ...
 */
    static void
f_winline(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    validate_cursor();
 ...
 */
    static void
f_winnr(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    int		nr = 1;
 ...
 */
    static void
f_winrestcmd(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
#ifdef FEAT_WINDOWS
 ...
 */
    static void
f_winrestview(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars;
    //typval_T	*rettv UNUSED;
{
    dict_T	*dict;
 ...
 */
    static void
f_winsaveview(typval_T* argvars, typval_T* rettv)
    //typval_T	*argvars UNUSED;
    //typval_T	*rettv;
{
    dict_T	*dict;
 ...
 */
    static pos_T *
var2fpos(typval_T* varp, int dollar_lnum, int* fnum)
    //typval_T	*varp;
 ...
 */
    static int
list2fpos(typval_T* arg, pos_T* posp, int *fnump)
    //typval_T	*arg;
    //pos_T	*posp;
    //int		*fnump;
{
 ...
 */
    static int
get_name_len(char_u** arg, char_u** alias, int evaluate, int verbose)
    //char_u	**arg;
    //char_u	**alias;
    //int		evaluate;
    //int		verbose;
 ...
 */
    static char_u *
find_name_end(char_u* arg, char_u** expr_start, 
 ...
 */
    void
set_vim_var_string(int idx, char_u* val, int len)
    //int		idx;
    //char_u	*val;
 ...
 */
    static int
get_var_tv(char_u* name, int len, typval_T* rettv, int verbose)
    //char_u	*name;
    //int		len;		/* length of "name" */
 ...
 */
    static int
handle_subscript(char_u** arg, typval_T* rettv, int evaluate, int verbose)
    //char_u	**arg;
    //typval_T	*rettv;
 ...
 */
    static dictitem_T *
find_var(char_u* name, hashtab_T** htp)
    //char_u	*name;
    //hashtab_T	**htp;
{
    char_u	*varname;
 ...
 */
    static dictitem_T *
find_var_in_ht(hashtab_T* ht, int htname, char_u* varname, int writing)
    //hashtab_T	*ht;
    //int		htname;
    //char_u	*varname;
    //int		writing;
 ...
 */
    static void
set_var(char_u* name, typval_T* tv, int copy)
    //char_u	*name;
    //typval_T	*tv;
 ...
 */
    static int
var_check_ro(int flags, char_u* name)
    //int		flags;
    //char_u	*name;
{
 ...
 */
    static int
var_check_fixed(int flags, char_u* name)
    //int		flags;
    //char_u	*name;
{
 ...
 */
    static int
var_check_func_name(char_u* name, int new_var)
 ...
 */
    static int
tv_check_lock(int lock, char_u* name)
    //int		lock;
    //char_u	*name;
{
    if (lock & VAR_LOCKED)
 ...
 */
    static int
item_copy(typval_T* from, typval_T* to, int deep, int copyID)
    //typval_T	*from;
    //typval_T	*to;
    //int		deep;
    //int		copyID;
 ...
 */
    static char_u *
trans_function_name(char_u** pp, int skip, int flags, funcdict_T* fdp)
    //char_u	**pp;
 ...
 */
    static int
script_autoload(char_u* name, int reload)
    //char_u	*name;
 ...
 */
   static void
free_funccal(funccall_T* fc, int free_val)
    //funccall_T	*fc;
 ...
 */
    static void
add_nr_var(dict_T* dp, dictitem_T* v, char* name, varnumber_T nr)
    //dict_T	*dp;
    //dictitem_T	*v;
    //char	*name;
    //varnumber_T nr;
 ...
 */
    int
do_return(exarg_T* eap, int reanimate, int is_cmd, void* rettv)
    //exarg_T	*eap;
    //int		reanimate;
    //int		is_cmd;
    //void	*rettv;
 ...
 */
    char_u *
get_func_line(int c, void* cookie, int indent)
    //int	    c UNUSED;
    //void    *cookie;
    //int	    indent UNUSED;
{
...
shortpath_for_invalid_fname(
        char_u** fname, char_u** bufp, int * fnamelen)
    //char_u	**fname;
    //char_u	**bufp;
    //int		*fnamelen;
{
 ...
 */
    static int
shortpath_for_partial(char_u** fnamep, char_u** bufp, int* fnamelen)
    //char_u	**fnamep;
    //char_u	**bufp;
    //int		*fnamelen;
{
 ...
 */
    char_u *
do_string_sub(char_u* str, char_u* pat, char_u* sub, char_u* flags)
    //char_u	*str;
    //char_u	*pat;
    //char_u	*sub;
    //char_u	*flags;
